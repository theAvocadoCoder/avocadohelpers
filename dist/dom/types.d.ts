export type htmlElementAttributes = {
    '*': 'accesskey' | 'autocapitalize' | 'autofocus' | 'class' | 'contenteditable' | 'dir' | 'draggable' | 'enterkeyhint' | 'hidden' | 'id' | 'inert' | 'inputmode' | 'is' | 'itemid' | 'itemprop' | 'itemref' | 'itemscope' | 'itemtype' | 'lang' | 'nonce' | 'popover' | 'slot' | 'spellcheck' | 'style' | 'tabindex' | 'title' | 'translate' | 'writingsuggestions';
